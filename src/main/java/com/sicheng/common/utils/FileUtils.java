...
public class FileUtils extends org.apache.commons.io.FileUtils {
    ...
    public static boolean isImg(String fileName) {
        String fileSuff = fileSuff(fileName);//fileSuff.equalsIgnoreCase("gif")
        if (fileSuff.equalsIgnoreCase("jpg") || fileSuff.equalsIgnoreCase("png") || fileSuff.equalsIgnoreCase("jpeg")
                || fileSuff.equalsIgnoreCase("bmp")) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isExcel(String fileName) {
        String fileSuff = fileSuff(fileName);
        if (fileSuff.equalsIgnoreCase("xls") || fileSuff.equalsIgnoreCase("xlsx")) {
            return true;
        }
        return false;
    }
     ...
     * @return
     */
    public static String fileSuff(String fileName) {
        if (fileName == null) {
            return null;
        }
    ...
    public static boolean copyFileCover(String srcFileName,
        ...
        if (descFile.exists()) {
            ...
            if (coverlay) {
                ...
                if (!FileUtils.deleteFileAndDir(descFileName)) {
    ...
    public static boolean copyDirectoryCover(String srcDirName,
        ...
        if (descDir.exists()) {
            if (coverlay) {
                ...
                if (!FileUtils.deleteFileAndDir(descDirNames)) {
...
//			e.printStackTrace();
    ...
    /**
     * 把byte[]表示的多个文件，放入一个zip压缩包中,写入输出流。全程在内存中操作，不依赖磁盘。
     * 目前不支持多级目录层次
     *
     * @param dataMap 文件名和文件内容
     * @param out     输出流
     */
    public static void zipByte(TreeMap<String, byte[]> dataMap, OutputStream out) {
        if (dataMap == null || out == null) {
            return;
        }
        try {
     ...
     * @return byte[]
     */
    public static byte[] readFileUtil(String filePath) {
        if (filePath == null) {
