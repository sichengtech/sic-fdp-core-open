...
//import com.sicheng.admin.sys.security.SystemAuthorizingRealm.Principal;
...
public class Servlets {
    ...
    /**
     * 是否是Ajax异步请求或是手机端登录管理后台的用户
     * @param request
     */
    public static boolean isAjaxRequest(HttpServletRequest request) {
        String accept = request.getHeader("accept");
        String xRequestedWith = request.getHeader("X-Requested-With");
//		2017-3-20 工程拆分时临时注释  zhaolei
...
//			|| (principal != null && principal.isMobileLogin())));
     ...
     * @param request
     */
    public static boolean isAjaxRequest2(HttpServletRequest request) {
        String accept = request.getHeader("accept");
        String xRequestedWith = request.getHeader("X-Requested-With");
