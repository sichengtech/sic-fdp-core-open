...
//		}));
    ...
    public <T> T fromJson(String jsonString, Class<T> clazz) {
        ...
        try {
            ...
            logger.warn("parse json string error:" + formatString(jsonString), e);
            return null;
        }
    }
    ...
    public <T> T update(String jsonString, T object) {
        try {
            ...
            logger.warn("update json string:" + formatString(jsonString) + " to object:" + object + " error.", e);
        }
        return null;
    }
    ...
    /**
     * 方法说明：把长字符串截短，便于在日志中输出
     *
     * @param jsonString
     * @return java.lang.String
     * @author zhalei
     * @version 2020-01-28 22:51
     */
    ...
    public static void main(String[] args) {
        ...
        map.put("empty1", "");
        map.put("empty2", null);
        map.put("arry", Lists.newArrayList());//空的ArrayList
        list.add(map);
        map = Maps.newHashMap();
        map.put("id", 2);
        map.put("pId", 1);
